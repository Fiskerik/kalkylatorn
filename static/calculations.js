...
function selectOptimization(preferences, inputs) {
    const strategy = preferences?.strategy || "longer";
    if (strategy === "maximize_parental_salary") {
        return optimizeParentalLeaveParentalSalary(preferences, inputs);
    }
...
export { selectOptimization as optimizeParentalLeave };
...
function dispatchOptimizeParentalLeave(preferences, inputs) {
    const strategy = preferences?.strategy || "longer";
    if (strategy === "maximize_parental_salary") {
        return optimizeParentalLeaveParentalSalary(preferences, inputs);
    }
...
export { dispatchOptimizeParentalLeave as optimizeParentalLeave };
...
const STRATEGY_OPTIMIZERS = Object.freeze({
    maximize_parental_salary: optimizeParentalLeaveParentalSalary,
    maximize: optimizeParentalLeaveLegacy,
    longer: optimizeParentalLeaveLegacy
});

export function optimizeParentalLeave(preferences, inputs) {
    const strategy = preferences?.strategy || "longer";
    const optimizer = STRATEGY_OPTIMIZERS[strategy] || optimizeParentalLeaveLegacy;
    return optimizer(preferences, inputs);
}
